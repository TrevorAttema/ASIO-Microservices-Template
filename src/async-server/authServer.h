...
#if 0
class CreateAccountCallData : public CallDataBase<authServer, Services::Account::AsyncService>
{
public:
	CreateAccountCallData(Services::Account::AsyncService* service, grpc::ServerCompletionQueue* queue, authServer* server)
		: CallDataBase(service, queue, server)
	{
	}
	void Proceed();
};

class UpdateAccountCallData : public CallDataBase<authServer, Services::Account::AsyncService>
{
public:
	UpdateAccountCallData(Services::Account::AsyncService* service, grpc::ServerCompletionQueue* queue, authServer* server)
		: CallDataBase(service, queue, server)
	{
	}
	void Proceed();
...
class ReadAccountCallData : public CallDataBase<authServer, Services::Account::AsyncService>
{
public:
	ReadAccountCallData(Services::Account::AsyncService* service, grpc::ServerCompletionQueue* queue, authServer* server)
		: CallDataBase(service, queue, server)
	{
	}
	void Proceed();
...
class ListAccountsCallData : public CallDataBase<authServer, Services::Account::AsyncService>
{
public:
	ListAccountsCallData(Services::Account::AsyncService* service, grpc::ServerCompletionQueue* queue, authServer* server)
		: CallDataBase(service, queue, server)
	{
	}
	void Proceed();
